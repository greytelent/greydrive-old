// load in head necessary statics
...
function nav(path) {
    ...
    <a href="https://github.com/greytelent/greydrive-old" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'greydrive Github'}">
